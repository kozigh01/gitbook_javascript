...
* [x] Udemy - Angular 6 \(formerly Angular 2\) - The Complete Guide: [Course](https://www.udemy.com/the-complete-guide-to-angular-2/learn/v4/overview) \| [Code](https://github.com/kozigh01/AngularAPICommAndAuth)
* [ ] Udemy - Build an app with ASPNET Core and Angular from scratch: [Course ](https://www.udemy.com/build-an-app-with-aspnet-core-and-angular-from-scratch/learn/v4/content)\| Code
* Bootstrap
